...
class ClientSearch extends Component<ClientSearchProps, ClientSearchState> {
    state = {
        isLoading: true,
        searchResults: [],
        search: null,
    ...
    render() {
        ...
        const { books } = this.props
        const queryResults: any = searchQuery === `` ? books : searchResults
        if (isLoading) {
            return (
                <div>
